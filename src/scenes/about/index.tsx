...
const About = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section
      ...
      className="bg-primary-800 py-32 md:h-full"
    >
      <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.About)}>
        <div className={`${flexSetup} w-5/6 flex-wrap-reverse mx-auto gap-12`}>
          {/* IMAGE */}
          <motion.div
          ...
          <div className="z-10 md:basis-5/12">
            ...
            >
              ...
              <p className="mt-8 text-base text-justify">
                ...
                Sed augue lacus viverra vitae congue. Id venenatis a condimentum
                vitae sapien pellentesque habitant. Enim eu turpis egestas
                pretium.
              </p>
            </motion.div>
        ...
        {isAboveMediumScreens && (
          <div className="h-[150px] w-full bg-primary-300 mt-32">
